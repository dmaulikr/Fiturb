...
+ (instancetype)showHUDAddedTo:(UIView *)view withScreenHeaderHeigth:(CGFloat)Headerheight animated:(BOOL)animated
{
    NSLog(@"View Heading Height is:%f",Headerheight);
    MBProgressHUD *hud = [[self alloc] initWithView:view withScreenHeaderHeigth:Headerheight];
...
- (id)initWithView:(UIView *)view withScreenHeaderHeigth:(CGFloat)height
{
    NSAssert(view, @"View must not be nil.");
    return [self initWithFrame:CGRectMake(0, height, view.frame.size.width, view.frame.size.height-height)];
}
